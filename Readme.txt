...
1-Dans Fichier main.py :
	...
	les methodes de la classe :
			- build () : permet d'initialiser les elements graphiques du jeux sous formes de 9 boutons 
...
2-Dans Fichier gameplayer.py:
	...
	les methodes de la classe :
			- make_random_move() : le joueur BOT au debut il joue au centre de la table si il est vide , sinon il cherche dans toutes les autres boutons vide si il peut ganger le jeu à l'aide du tableau winning_combos deja definie sinon il va jouer d'une maniere aleatoire.